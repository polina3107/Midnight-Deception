...
#region eavesdrop miles and victor
label eavesdrop:
    scene balcony
...
#region join conversation between miles and victor
label conversation:
    scene balcony
...
#region daniel is murdered, first branch
label murder_time:
    scene corridor
    with fade
...
#region warning screen to mini-game "Escape" (maybe use for every mg)
...
#region after mini-game "Escape" - win
label escape_win:
...
#region after mini-game "Escape" - lose
label escape_lose:
...
#region interrogate people to know extra info
...
#region calm group - no extra info for player
label calm_group:
...
#region choice that leads to 5 mini-games
label investigation:
...
label search_minigame:
    ...
    call screen mg_search_intro

    call screen mg_search
